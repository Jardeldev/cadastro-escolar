<template>
  <Menu />
    <ion-page>
      ...
      <ion-content>
        ...
        <div class="form-container" v-if="isAddModalOpen">
  ...
  import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonButton, IonIcon, IonList, IonItem, IonLabel, IonInput, IonTextarea } from '@ionic/vue';
